...
def test_logger_notifier_no_alert(logger: Logger, notifier: Notifier, capsys: CaptureFixture[str]) -> None:
...
def test_logger_notifier_with_alert(logger: Logger, notifier: Notifier, capsys: CaptureFixture[str]) -> None:
