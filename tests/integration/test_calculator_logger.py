...
def test_calculator_logger_addition(calculator, logger, capsys):
...
def test_calculator_logger_subtraction(calculator, logger, capsys):
...
def test_calculator_logger_multiplication(calculator, logger, capsys):
...
def test_calculator_logger_division(calculator, logger, capsys):
...
def test_calculator_logger_divide_by_zero(calculator, logger, capsys):
