...
def test_calculator_logger_addition(
    ...
    assert "LOG: Adding 5 + 3 = 8" in captured.out, "Incorrect log output"
...
def test_calculator_logger_subtraction(
    ...
    assert "LOG: Subtracting 10 - 4 = 6" in captured.out, "Incorrect log output"
...
def test_calculator_logger_multiplication(
    ...
    assert "LOG: Multiplying 6 * 7 = 42" in captured.out, "Incorrect log output"
...
def test_calculator_logger_division(
    ...
    assert "LOG: Dividing 10 / 2 = 5.0" in captured.out, "Incorrect log output"
...
def test_calculator_logger_divide_by_zero(
    ...
    captured = capsys.readouterr()
    assert "LOG: Attempted to divide by zero" in captured.out, "Incorrect log output"